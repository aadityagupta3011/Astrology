...
const Home = () => {
  const headerData = {
    title: "Renowned Sharma Ji - Globally Acclaimed for Exceptional Astrological Expertise",
    description: "As the accomplished son of a globally renowned figure, Nikhil Sharma, a distinguished Indian astrologer, has risen to become one of the most sought-after and esteemed astrologers and vashik. Throughout his illustrious career spanning decades, he has skillfully applied his expertise in Vedic astrology and benevolent vashikaran to make a profound impact on life.",
  };
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="w-full px-4 py-8 bg-gradient-to-r from-purple-50 to-purple-200">
          <h2 className="text-3xl font-bold text-center text-purple-700 mb-6">About Sharma Ji</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-slate-300 shadow-md p-4 rounded-lg">
              <h3 className="text-xl font-semibold mb-2">Address</h3>
              <p className="text-gray-600">
                <strong>Dubai:</strong> Al Furjan East<br />
                <span className="block">+971 527912616</span>
                <strong>India:</strong> Maha Laxmi Astro Dham, Kangra, Himachal Pradesh<br />
            ...
            <div className="bg-green-300 shadow-md p-4 rounded-lg">
              ...
              <p className="text-gray-600">
                Shree Santan Dhram Sanskrit College, Ujjain<br />
                Kashi, Haridwar<br />
                Hoshiyarpur, Punjab
              </p>
            </div>
            ...
            <div className="bg-slate-300 shadow-md p-4 rounded-lg">
              ...
              <p className="text-gray-600">
                <strong>2021:</strong> Bollywood Actress Nora Fatehi<br />
                <strong>2022:</strong> Actress Malaika Arora<br />
                <strong>2023:</strong> Bollywood Actor Sonu Sood<br />
            ...
            <div className="bg-green-300 shadow-md p-4 rounded-lg">
              ...
              <p className="text-gray-600">
                Practicing astrology since childhood, following the family tradition since 1970. Father and grandfather were renowned astrologers.
              </p>
            </div>
            ...
            <div className="bg-slate-300 shadow-md p-4 rounded-lg">
              ...
              <p className="text-gray-600">
                Branches in Malaysia, Mauritius, Singapore, Europe, and Dubai. Now based in Dubai and serving clients worldwide.
              </p>
            </div>
            ...
            <div className=" bg-green-300 shadow-md p-4 rounded-lg">
              ...
              <p className="text-gray-600">
                Consults with famous personalities, including Bollywood actors, actresses, and political figures.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full bg-white flex flex-col lg:flex-row lg:items-start lg:justify-between p-4 lg:p-6">
          <div className="flex-1 lg:mr-4 mb-6 lg:mb-0">
            ...
            <img src={awardCeremony} alt="Award Ceremony" className="w-full rounded-lg mt-4" />
          </div>
